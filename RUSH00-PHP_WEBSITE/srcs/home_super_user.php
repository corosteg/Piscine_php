...
<!DOCTYPE html>
<html>
	<head><title>Acceuil super user</title></head>
	<body style="background-color:blue">
		<div style="background-color:pink;margin-bottom:15vw">
			...
			<p style="display:inline-block">bonjour <?PHP echo "$_SESSION[logged_on_user]"?></a></p>
			<a href="./deconect.php">DECONEXION</a>
			<a href="./admin_home.php">Acces cote admin</a>
		</div>
